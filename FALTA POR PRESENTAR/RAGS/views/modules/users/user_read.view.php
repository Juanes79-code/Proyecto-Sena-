              ...
              <table class="table">
                ...
                <?php foreach ($usuarios as $usuario) : ?>
                    <tr>
                      ...
                      <td class="">
                        <a href="?c=Users&a=userUpdate&idUser=<?php echo $usuario->getCodigoUser(); ?>" class="editar">Editar
                          <i class="fa-solid fa-pen-to-square"></i>
                        </a>
                        <a href="?c=Users&a=userDelete&idUser=<?php echo $usuario->getRolCode(); ?>" class="eliminar">Eliminar
